...
import com.project.e_lakis.databinding.ActivityReport2Binding
...
class ReportActivity2 : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityReport2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webView.webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                this@ReportActivity2.filePathCallback = filePathCallback
                ...
                startActivityForResult(chooserIntent, ReportActivity2.INPUT_FILE_REQUEST_CODE)
        ...
        webView.loadUrl("https://form.jotform.com/233044298481459")
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == ReportActivity2.INPUT_FILE_REQUEST_CODE) {
        ...
        if (requestCode == ReportActivity2.CAMERA_INPUT_FILE_REQUEST_CODE) {
